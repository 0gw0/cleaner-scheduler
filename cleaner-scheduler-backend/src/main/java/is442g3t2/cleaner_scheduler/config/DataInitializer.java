...
public class DataInitializer {
    ...
    CommandLineRunner initDatabase(
        ...
        return args -> {
            ...
            // Create Workers
            Worker worker1 = new Worker("Mati", "1234567890", "eg bio 1", "email1@gmail.com", "password123", "188065");
            Worker worker2 = new Worker("Yati", "0987654321", "eg bio 2", "email2@gmail.com", "password123", "188065");
            Worker worker3 = new Worker("Wati", "1122334455", "eg bio 3", "email3@gmail.com", "password123", "188065");
